...
<head>
    ...
    <title>Registrasi Luar Daerah</title>
	<!-- Bootstrap Styles-->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href='/pelaporandd'><i class="fa fa-fw fa-file"></i>Pelaporan Dalam Daerah</a>
                    </li>
                    <li>
                        <a class="active-menu" href='pelaporanld'><i class="fa fa-fw fa-file"></i>Pelaporan Luar Daerah</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Registrasi Pelaporan Luar Daerah
                        </h1>
						<ol class="breadcrumb">
					  <li><a href="#">Home</a></li>
					  <li class="active">Pelaporan Luar Daerah</li>
					</ol> 
